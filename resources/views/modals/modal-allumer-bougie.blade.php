    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" id="tab1">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <img id="bougie-gif" width=100% src="{{ asset("public/front/img/bougie.gif") }}"/>
                    </div>
                    <div class="col-12 message-step-1">
                        <i class="icon-fire-1 fire-jaune"></i>
                        <span class=" fire-jaune" id="nbreIncrementeBougie"></span> {{ __('website.modal-allumer-tab2-message2') }}
                    </div>
                    <div class="col-12 message-step-1">
                        <button type="button" class="btn btn-light-candle" onclick="dedication()">
                            <i class="icon-fire-1 fire"></i>{{ __('website.write-personal-dedication') }}
                        </button>
                        <button type="button" class="btn btn-light-candle" onclick="share()">
                            <i class="icon-share fire"></i>{{ __('website.share') }}
                        </button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal-content" id="tab2">
            <form id="form-dedicace">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-candle btn-dedicace margin-0-auto" onclick="dedicace('{{ url('/dedicace') }}', '#form-dedicace')">
                        <div class="spinner-border spinner-border-sm mr-2" role="status">
                            <span class="sr-only">Loading...</span>
                        </div>
                        <i class="icon-fire-1 fire"></i>{{ __('website.submit-dedication') }}
                    </button>
                </div>
            </form>
        </div>
        <div class="modal-content display-none" id="tab3">
            <div class="modal-header background-modal-allumer-bougie">
