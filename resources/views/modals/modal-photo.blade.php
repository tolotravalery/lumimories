<div class="modal fade" id="modal-photo" tabindex="-1" aria-labelledby="light-candleLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="light-candleLabel">{{ __('website.add')." ".__('website.picture') }}</h5>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <div class="input-photo display-flex"></div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input class="form-control" type="text" name="nomDesGens" value="{{ old('nomDesGens') }}" placeholder="{{ __('website.name-of-people-in-the-picture') }}">
                                @if ($errors->has('nomDesGens'))
                                    <small class="form-text text-danger text-left" id="error">{{ $errors->first('nomDesGens') }}</small>
                                @endif
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="text" onfocus="(this.type='date')" name="dateDuPhoto" value="{{ old('dateDuPhoto') }}" placeholder="{{ __('website.photo-date') }}">
                                @if ($errors->has('dateDuPhoto'))
                                    <small class="form-text text-danger text-left" id="error">{{ $errors->first('dateDuPhoto') }}</small>
                                @endif
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="commentaires" rows="1" placeholder="{{ __('website.comment-the-photo') }}">{{ old('commentaires') }}</textarea>
