                ...
                <div class="col-lg-7">
                    <nav id="menu" class="main-menu float-left">
                        <ul id="top_access">
                            ...
                            <li><a onclick="scrollRecherche()" class="page-scroll display-inherit surligne-hover"><i class="fa fa-search"></i> <span class="font-weight-bold"> {{ __('website.search') }} </span> </a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-5">
                    <nav id="menu" class="main-menu height-100-100">
                        <ul id="top_access" class="height-100-100">
                            ...
                            @if(Auth::check())
                                ...
                                {{--<li class="text-center">
                                    <a data-toggle="modal" data-target="#logoutModal" class="surligne-hover"><i class="fa fa-2x fa-sign-out"></i>{{ __('website.sign-out') }}</a>
                                </li>--}}
                            @endif
                            @if(Auth::check()==false)
                                <li class="text-center">
